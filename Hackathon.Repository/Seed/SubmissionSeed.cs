...
public static class SubmissionSeed
{
    ...
    public static void SeedSubmissions(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Submissions>().HasData(
            ...
            new Submissions { Id = Sub6, RoundDetailId = RoundDetailSeed.Rd6, Url = "https://github.com/test/project1-v2", Description = "Beta Prototype Code", Status = SubmissionStatusEnum.Graded, SubmittedAt = SeedConstants.CreatedAt.AddDays(13), IsRegrade = false, IsDisable = false, CreatedAt = SeedConstants.CreatedAt, UpdatedAt = SeedConstants.CreatedAt },
            new Submissions { Id = Sub7, RoundDetailId = RoundDetailSeed.Rd7, Url = "https://github.com/test/project2-v2", Description = "Beta Web Code", Status = SubmissionStatusEnum.Graded, SubmittedAt = SeedConstants.CreatedAt.AddDays(13), IsRegrade = false, IsDisable = false, CreatedAt = SeedConstants.CreatedAt, UpdatedAt = SeedConstants.CreatedAt },
            new Submissions { Id = Sub8, RoundDetailId = RoundDetailSeed.Rd8, Url = "https://github.com/test/project-single", Description = "Final submission for single round", Status = SubmissionStatusEnum.Graded, SubmittedAt = SeedConstants.CreatedAt.AddDays(12), IsRegrade = false, IsDisable = false, CreatedAt = SeedConstants.CreatedAt, UpdatedAt = SeedConstants.CreatedAt },
            new Submissions { Id = Sub9, RoundDetailId = RoundDetailSeed.Rd9, Url = "https://github.com/test/project-summer-1", Description = "Summer Round 1 doc", Status = SubmissionStatusEnum.Graded, SubmittedAt = SeedConstants.CreatedAt.AddDays(12), IsRegrade = false, IsDisable = false, CreatedAt = SeedConstants.CreatedAt, UpdatedAt = SeedConstants.CreatedAt },
            new Submissions { Id = Sub10, RoundDetailId = RoundDetailSeed.Rd10, Url = "https://github.com/test/project-autumn-1", Description = "Autumn Round 1 doc", Status = SubmissionStatusEnum.Graded, SubmittedAt = SeedConstants.CreatedAt.AddDays(12), IsRegrade = false, IsDisable = false, CreatedAt = SeedConstants.CreatedAt, UpdatedAt = SeedConstants.CreatedAt },
