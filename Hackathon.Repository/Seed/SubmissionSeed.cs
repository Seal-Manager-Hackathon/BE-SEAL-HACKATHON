...
public static class SubmissionSeed
{
    ...
    public static void SeedSubmissions(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Submissions>().HasData(
            ...
            new Submissions { Id = Sub5, RoundDetailId = RoundDetailSeed.Rd5, Url = null, Description = "Cloud Deployment Draft", Status = SubmissionStatusEnum.Unsubmitted, SubmittedAt = null, IsRegrade = false, IsDisable = false, CreatedAt = SeedConstants.CreatedAt, UpdatedAt = SeedConstants.CreatedAt }, // unsubmitted
            ...
            new Submissions { Id = Sub12, RoundDetailId = RoundDetailSeed.Rd12, Url = null, Description = "Winter Round 1 blank", Status = SubmissionStatusEnum.Unsubmitted, SubmittedAt = null, IsRegrade = false, IsDisable = true, CreatedAt = SeedConstants.CreatedAt, UpdatedAt = SeedConstants.CreatedAt } // disabled submission
        );
    }
}
