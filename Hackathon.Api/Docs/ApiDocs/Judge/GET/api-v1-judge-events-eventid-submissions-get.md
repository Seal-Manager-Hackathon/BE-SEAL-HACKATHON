...
## Tác dụng
Giúp Judge xem danh sách các bài nộp (submissions) của các team thuộc các track được phân công trong một event. Hỗ trợ lọc theo track, round và phân trang.
...
- Nếu truyền `trackId`: chỉ lấy submission trong track đó.
- Nếu truyền `roundId`: chỉ lấy submission trong round đó.
