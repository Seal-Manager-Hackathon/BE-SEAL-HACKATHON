...
## Tác dụng
Staff hoặc Admin lấy danh sách phân công (`AssignEvents`) trong sự kiện, bao gồm các vai trò `Mentor`, `Judge`, `Staff`. Có hỗ trợ lọc theo vai trò (EventRoleEnum), tìm kiếm tên/email, lọc soft-disable và phân trang.
