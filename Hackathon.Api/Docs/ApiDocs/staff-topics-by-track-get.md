...
| `pageIndex` | `int` | Không | Trang hiện tại, mặc định `1`. Nếu truyền `<= 0`, service nên tự đổi về `1`. |
| `pageSize` | `int` | Không | Số item mỗi trang, mặc định `10`. Nếu truyền `<= 0`, service nên tự đổi về `10`; tối đa `100`. |
